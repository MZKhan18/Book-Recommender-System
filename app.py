...
if st.button('Recommend'):
    ...
    with col1:
        if poster[0] != 'Not Available':
            st.image(poster[0], width=235)
        else:
            st.header(":red[image not available]")
    ...
    with col1:
        ...
        if poster[2] != 'Not Available':
            st.image(poster[2], width=235)
        else:
            st.header(":red[image not available]")
        ...
        st.write("Authors : " + aName)
        st.write("Ratings : " + str(rating[2]))
        st.write("Votes : " + str(votes[2]))

    with col2:
        if poster[3] != 'Not Available':
